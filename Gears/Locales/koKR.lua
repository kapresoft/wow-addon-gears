...
L['Alt-click']                  = 'Alt-클릭'
L['Keep open this session']     = '이번 세션 동안 열어 두기'
L['Kept open this session']     = '이번 세션 동안 열어 둠'
L['Close and stop keeping open'] = '닫고 더 이상 열어 두지 않기'
L['Resets on /reload']          = '/reload 시 초기화됨'
